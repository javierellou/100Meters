...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("100Meters", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("100Meters", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "12";
		app.meta["company"] = "Javiereo";
		app.meta["file"] = "100Meters";
		app.meta["name"] = "100Meters";
